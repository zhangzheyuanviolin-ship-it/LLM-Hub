...
# PATCHED: Skip IPO check for Android NDK (gold linker removed)
if(ANDROID)
  macro(check_ipo_supported)
    cmake_parse_arguments(IPO "" "RESULT;OUTPUT" "LANGUAGES" ${ARGN})
    if(IPO_RESULT)
      set(${IPO_RESULT} NO PARENT_SCOPE)
    endif()
    if(IPO_OUTPUT)
      set(${IPO_OUTPUT} "IPO not supported on Android (gold linker removed in NDK 26+)" PARENT_SCOPE)
    endif()
  endmacro()
  return()
endif()
